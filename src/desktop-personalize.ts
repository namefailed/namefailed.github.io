...
export function initDesktopPersonalize(desktopEl: HTMLElement): void {
  ...
  themeSelect.addEventListener('change', () => {
    ...
    const clockSelect = document.getElementById('settings-theme-select') as HTMLSelectElement | null
    if (clockSelect && clockSelect !== themeSelect) {
      if ([...clockSelect.options].some(o => o.value === id)) clockSelect.value = id
    }
    playOsSound('click')
  })
