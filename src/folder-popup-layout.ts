...
/**
 * Pick above vs below by comparing the space around the anchor against the
 * popup's own height, then clamp to the viewport. Shared by all three folder tiles.
 */
